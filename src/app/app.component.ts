...
export class AppComponent {
  cities: City[] = [
    ...
    { 
      ...
      targa: 'MI',
       provincia: 'Milano', 
       descrizione: "è un comune italiano di 1 363 411 abitanti, capoluogo della regione Lombardia e dell'omonima città metropolitana, centro di una delle più popolose aree metropolitane d'Europa; è inoltre il secondo comune più popoloso d'Italia (dopo Roma) e rientra tra le venti città più grandi dell'intera Europa.", 
       nome: 'Milano',
       capoluogo:true 
       },
    { 
